...
private:
    ...
    static void PrintTransferLogRecordLine(clsBankClients::stTrnsferLogRecord TransferLogRecord)
    {
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        vector <clsBankClients::stTrnsferLogRecord> vTransferLogRecord = clsBankClients::GetTransfersLogList();
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (clsBankClients::stTrnsferLogRecord Record : vTransferLogRecord)
            {
